...
class Users(Resource):
    def get(self):
        ...
        if args['userId'] in list(data['userId']):
            #se recupera informacion de el usuario con el Id indicado
            user_data = data[data['userId'] == args['userId']]
            return {'data': user_data.to_dict()}, 200  # return data and 200 OK
...
api.add_resource(UsersAll, '/users/all')  # add endpoints
